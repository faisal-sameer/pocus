...
<header class="header">
  ...
  <nav id="nav" class="nav">
    ...
    <a href="{{ route('DashboardCourse') }}" class="nav-link"><h3>Dashboard Course</h3></a>
    ...
    <div class="container" style="direction: ltr">
        <div class="notification-dashboard bounce-in-top">
            ...
            <div class="row">
              ...
              <div class="col-sm-4">                  
                <input type="text" style="text-align: right;direction: rtl" id="inputregister" name="Name" placeholder="اسم الدورة">
              </div>
            </div>
